...
namespace AutoTest.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260401172924_AddAnimatedTestTables")]
    partial class AddAnimatedTestTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoTest.Domain.Entities.AnimatedTestAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AnimatedTestAnswers", "autotest");
                });

            modelBuilder.Entity("AutoTest.Domain.Entities.AnimatedTestSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<short>("ScorePercentage")
                        .HasColumnType("smallint");
                    ...
                    b.ToTable("AnimatedTestSessions", "autotest");
                });
            ...
            modelBuilder.Entity("AutoTest.Domain.Entities.AnimatedTestAnswer", b =>
                {
                    b.HasOne("AutoTest.Domain.Entities.AnimatedTestSession", "Session")
                        .WithMany("Answers")
